...
class DeliveryratesController extends Controller
{
    ...
    public function display(){
      ...
      return view("admin.deliveryrates.index",$title)->with('data', $deliveryrates);
    }
    ...
    public function filter(Request $request){
        ...
        return view("admin.deliveryrates.index",$title)->with('data', $deliveryrates)->with('name', $name)->with('parameter', $param);
