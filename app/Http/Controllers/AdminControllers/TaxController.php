...
{
    public function __construct(Countries $countries,Zones $zones,Tax_class $tax_class,Tax_rate $tax_rate)
    {
    ...
    public function taxindex(Request $request){
        ...
        return view("admin.tax.taxclass.index", $title)->with('tax_class', $tax_class);
    }

    public function addtaxclass(Request $request){
        $title = array('pageTitle' => Lang::get("labels.AddTaxClass"));
        return view("admin.tax.taxclass.add", $title);
    }
    ...
    public function edittaxclass(Request $request){
        ...
        return view("admin.tax.taxclass.edit",$title)->with('taxClass', $taxClass);
    }
    ...
    public function filtertaxclass(Request $request){
        ...
        return view("admin.tax.taxclass.index", $title)->with('tax_class', $tax_class)->with('name', $name)->with('param', $param);
    }
