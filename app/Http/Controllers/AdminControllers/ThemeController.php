...
class ThemeController extends Controller
{
    ...
    public function moveToBanners($banner_id){
      ...
      return view('admin.theme.banner_images')->with('banner',$banner);
    }
    ...
    public function moveToSliders($carousal_id){
      ...
      return view('admin.theme.slider_images')->with('slider',$slider);
    }
    ...
    public function index2($id){
      ...
      return view("admin.theme.index")->with(['data' => $data,'current_theme' => $current_theme ]);
    }
