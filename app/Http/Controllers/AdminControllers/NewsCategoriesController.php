...
class NewsCategoriesController extends Controller
{
    ...
    public function display(){
            ...
            return view("admin.newscategories.index",$title)->with('listingCategories', $listingCategories);
    ...
    public function filter(Request $request){
        ...
        return view("admin.newscategories.index",$title)->with('listingCategories', $listingCategories)->with('name', $name)->with('param', $param);
