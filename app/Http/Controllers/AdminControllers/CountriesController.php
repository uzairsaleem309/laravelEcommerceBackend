...
class CountriesController extends Controller
{
    ...
    public function __construct(Countries $countries,Zones $zone,Tax_class $tax_class,Tax_rate $tax_rate)
    {
    ...
    public function index(Request $request){
        ...
        return view("admin.countries.index",$title)->with('countryData', $countryData);
    }

    public function add(Request $request){
        $title = array('pageTitle' => Lang::get("labels.AddCountry") );
        return view("admin.countries.add",$title);
    }
    ...
    public function edit($id){
        ...
        return view("admin.countries.edit",$title)->with('country', $country);
    }
    ...
    public function filter(Request $request){
        ...
        $countryData['message'] = $message;
        $countryData['countries'] = $countries;
        return view("admin.countries.index",$title)->with('countryData', $countryData)->with('name', $name)->with('param', $param);
    }
