                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?php echo e(URL::to('admin/addpage')); ?>" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddNew')); ?></a>
                            </div>
                            </br>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                        <tr>
                                            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('page_id', trans('labels.ID')));?></th>
                                            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('Name', trans('labels.Name')));?></th>
                                            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('slug', trans('labels.Slug')));?></th>
                                    ...
                                    <div class="col-xs-12 text-right">
                                        <?php echo $result["pages"]->appends(\Request::except('page'))->render(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qhmarket/public_html/resources/views/admin/pages/index.blade.php ENDPATH**/ ?>