...
$.each(new Array(12),
function(n){$("#banner_img_"+n).hover(function(){
$(".hover_option").css("display","none");
...
<?php if(Request::path() == 'admin/deliveryboys/eagleview'): ?>
<script async defer
...
<script>
      var map;
      function initMap() {
        map = new google.maps.Map(document.getElementById('deliveryboys-map'), {
          zoom: 2,
...
<?php endif; ?>
<?php /**PATH /home/qhmarket/public_html/bk/resources/views/admin/common/scripts.blade.php ENDPATH**/ ?>