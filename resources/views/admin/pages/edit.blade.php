    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/pages')}}"><i class="fa fa-gears"></i> {{ trans('labels.ListingAllPages') }}</a></li>
                          ...
                          <h3 class="box-title">{{ trans('labels.EditPage') }}</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('admin/pages')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
