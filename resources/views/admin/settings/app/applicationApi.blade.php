                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][68]->name, $result['settings'][68]->value, array('readonly'=>'readonly', 'class'=>'form-control', 'id'=>$result['settings'][68]->name)) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][69]->name, $result['settings'][69]->value, array('readonly'=>'readonly', 'class'=>'form-control', 'id'=>$result['settings'][69]->name)) !!}
