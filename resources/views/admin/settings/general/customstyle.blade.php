                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::textarea($result['settings'][76]->name,  stripslashes($result['settings'][76]->value), array('class'=>'form-control', 'id'=>$result['settings'][76]->name)) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::textarea($result['settings'][77]->name,  stripslashes($result['settings'][77]->value), array('class'=>'form-control', 'id'=>$result['settings'][77]->name)) !!}
