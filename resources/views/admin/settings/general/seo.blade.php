                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][72]->name,  stripslashes($result['settings'][72]->value), array('class'=>'form-control', 'id'=>$result['settings'][72]->name)) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][73]->name,  stripslashes($result['settings'][73]->value), array('class'=>'form-control', 'id'=>$result['settings'][73]->name)) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][74]->name,  stripslashes($result['settings'][74]->value), array('class'=>'form-control', 'id'=>$result['settings'][74]->name)) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::textarea($result['settings'][75]->name,  stripslashes($result['settings'][75]->value), array('class'=>'form-control', 'id'=>'editor')) !!}
