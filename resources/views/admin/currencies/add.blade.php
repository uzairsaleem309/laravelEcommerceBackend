                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.Currency') }}
                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.symbol_left') }}
                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text('symbol_left', '', array('class'=>'form-control ',
                                                'id'=>'symbol_left'))!!}
                                                <span class="help-block"
                                                    style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label">{{ trans('labels.symbol_right') }}
                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text('symbol_right', '', array('class'=>'form-control ',
                                                'id'=>'symbol_right'))!!}
                                                <span class="help-block"
                                                    style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
