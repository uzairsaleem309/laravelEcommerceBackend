...
jQuery(document).ready(function() {
    ...
    jQuery('#rev_slider_1_fullscreen').show().revolution({
...
jQuery(document).ready(function() {
    ...
    /* initialize the slider based on the Slider's ID attribute */
    jQuery('#rev_slider_1_fullwidth').show().revolution({
...
jQuery(document).ready(function() {
    ...
    jQuery('#rev_slider_1_navigation').show().revolution({


        /* options are 'auto', 'fullwidth' or 'fullscreen' */
        //sliderLayout: 'auto',

        responsiveLevels: [1200, 1199, 991, 768],

        gridwidth: [885, 700, 885, 885],
        gridheight: [418, 418, 418, 418],
...
jQuery(document).ready(function() {
    ...
    /* initialize the slider based on the Slider's ID attribute */
    jQuery('#rev_slider_1_leftbanner').show().revolution({
        ...
        gridwidth: [834, 700, 480, 320],
        gridheight: [418, 418, 320, 300],
...
jQuery(document).ready(function() {
    ...
    /* initialize the slider based on the Slider's ID attribute */
    jQuery('#rev_slider_1_rightbanner').show().revolution({
...
var x = setInterval(function() {
    ...
    var timer_string = hours+"h "+minutes+"m "+ seconds+"s ";
...
$inputTo.on("input", function () {
    ...
    (function() {			
        ...
        if(tpj("#rev_slider_263_1_fullscreen").revolution == undefined){
            revslider_showDoubleJqueryError("#rev_slider_263_1_fullscreen");
        }else{
            revapi263 = tpj("#rev_slider_263_1_fullscreen").show().revolution({
    ...
    (function() {			
        ...
        function onLoad() {				
            if (tpj===undefined) { tpj = jQuery; if("off" == "on") tpj.noConflict();}
        if(tpj("#rev_slider_263_1_fullwidth").revolution == undefined){
            revslider_showDoubleJqueryError("#rev_slider_263_1_fullwidth");
        }else{
            revapi263 = tpj("#rev_slider_263_1_fullwidth").show().revolution({
                ...
                // responsiveLevels:[1240,1024,778,480],
                // visibilityLevels:[1240,1024,778,480],
                gridwidth:[1172,1024,768,480],
                gridheight:[425,419,480,320],
                lazyType:"none",
                shadow:0,
                spinner:"off",
                stopLoop:"on",
    ...
    (function() {			
        ...
        function onLoad() {				
            if (tpj===undefined) { tpj = jQuery; if("off" == "on") tpj.noConflict();}
        if(tpj("#rev_slider_263_1_navigaton").revolution == undefined){
            revslider_showDoubleJqueryError("#rev_slider_263_1_navigaton");
        }else{
            revapi263 = tpj("#rev_slider_263_1_navigaton").show().revolution({
    ...
    (function() {			
        ...
        function onLoad() {				
            if (tpj===undefined) { tpj = jQuery; if("off" == "on") tpj.noConflict();}
        if(tpj("#rev_slider_263_1_leftbanner").revolution == undefined){
            revslider_showDoubleJqueryError("#rev_slider_263_1_leftbanner");
        }else{
            revapi263 = tpj("#rev_slider_263_1_leftbanner").show().revolution({
    ...
    (function() {			
        ...
        function onLoad() {				
            if (tpj===undefined) { tpj = jQuery; if("off" == "on") tpj.noConflict();}
        if(tpj("#rev_slider_263_1_rightbanner").revolution == undefined){
            revslider_showDoubleJqueryError("#rev_slider_263_1_rightbanner");
        }else{
            revapi263 = tpj("#rev_slider_263_1_rightbanner").show().revolution({
