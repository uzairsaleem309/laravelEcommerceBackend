              ...
              <div class="col-sm-12 dragable-box" id="carousal_img">
                <div class="row">
                    ...
                    <div class="hover_option carousal_options">
                      ...
                      <div class="" v-for="carousal in carousals" v-if="carousal.id == current_theme.carousel" >
                        <a :href="'/admin/theme/setting/carousals/' + carousal.id" class="btn  btn-primary btn_custom_style">
                          <i class="fa fa-plus"  data-toggle="tooltip" title="Upload Slider Images"></i> &nbsp; Add Slider
                        </a>
                      </div>
                      <div class=""  v-for="carousal in carousals" v-if="(current_theme.carousel == 3 && carousal.id == 3) || (current_theme.carousel == 5 && carousal.id == 5)">
                        <a :href="'/admin/theme/setting/' + 20" class="btn  btn-primary btn_custom_style">
                          <i class="fa fa-plus"  data-toggle="tooltip" title="Upload Carousal Banner Images"></i> &nbsp; Add Banner Image
                        </a>
                      </div>
                    </div>
                  </div>
                    ...
                    <div :id="['banner_img_' + product_section_order.order]" class="col-sm-12 dragable-box dragable-box-cursor" v-for="product_section_order in product_section_orderss">
                      <div class="row" >
                        ...
                        <div :class="['hover_option banner_options_' + product_section_order.order]">
                          ...
                          <div class="" v-if="product_section_order['id'] == 1 ">
                            <a :href="'/admin/theme/setting/' + banner_id_for_href" class="btn  btn-primary btn_custom_style">
                              <i class="fa fa-plus"  data-toggle="tooltip" title="Upload Banner Images"></i> &nbsp; Upload
                            </a>
                          </div>
                          <div class="" v-if="product_section_order['id'] == 4 ">
                            <a :href="'/admin/theme/setting/' + 22" class="btn  btn-primary btn_custom_style">
                              <i class="fa fa-plus"  data-toggle="tooltip" title="Upload Banner Images"></i> &nbsp; Upload
                            </a>
                          </div>
                          <div class="" v-if="product_section_order['id'] == 10 ">
                            <a :href="'/admin/theme/setting/' + 21" class="btn  btn-primary btn_custom_style">
                              <i class="fa fa-plus"  data-toggle="tooltip" title="Upload Banner Images"></i> &nbsp; Upload
                            </a>
                          </div>
                        </div>
